# from __future__ import annotationsrequest

import json
import logging
import os
from typing import Any
from get_data import load_params_from_txt
import typer
...
requests_file_path = os.path.join(pre_user_path,user_name,post_user_path,'requests.log')
...
logging.basicConfig(
    ...
    handlers=[logging.StreamHandler(), logging.FileHandler(requests_file_path)],
)
